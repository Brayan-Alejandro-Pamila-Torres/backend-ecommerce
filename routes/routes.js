  ...
  try {
    ...
    stream.on('finish', async () => {
        try {
            ...
            console.log("📩 Recibo enviado correctamente con RESEND.");
            return res.json({
                ok: true,
    ...
    try {
      await resend.emails.send({
        ...
        html: `
          ...
          <p><i>"EL ORIGINAL ERES TÚ"</i></p>
          <p>Aquí tienes tu cupón especial:</p>
          <p><b>🎁 CUPÓN DE DESCUENTO INCLUIDO EN ESTE CORREO</b></p>
        `,
        attachments: [
          {
            filename: "cupon.png",
      ...
      console.log("Correo de suscripción enviado con Resend:", correo);
    } catch (mailErr) {
